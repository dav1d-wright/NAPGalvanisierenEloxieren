...
\begin{longtable}{p{3cm}p{14cm}}
	\hline
	\textbf{Saure Reaktion bei der Vernickelung}
...
\begin{longtable}{p{3cm}p{14cm}}
	& Gleichzeitig wird an der Kathode \chemfig{H^{+}} zu H reduziert.\\
\end{longtable}

\begin{figure}[H]\centering
	$$2\chemfig{H_{3}O^{+}} +2\chemfig{e^{-}} \chemrel{->} \chemfig{H_{2}} + 2\chemfig{H_{2}O}$$
	\caption{Reduktion von Wasserstoff an \\ der Kathode beim Vernickeln}
\end{figure}	
	
\begin{longtable}{p{3cm}p{14cm}}
		& Dadurch wird schwerlösliches $\chemfig{Ni}(\chemfig{OH})_2$ ausgefällt, dies führt schlussendlich dazu, dass die Nickelabscheidung behindert wird. Zur Verhinderung dessen muss die Lösung mit Borsäure (\chemfig{H_{3}BO_{3}}) gepuffert werden.\\
	\hline
	\textbf{Reaktions-gleichungen}
